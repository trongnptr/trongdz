...
// Lắng nghe sự kiện click vào button Checkout
...
// Xử lý form submit ở trang checkout.html
...
if (checkoutForm) {
    checkoutForm.addEventListener('submit', (event) => {
        ...
        // Gửi dữ liệu (ở đây là giả sử gửi thành công)
        // Để giả lập, ẩn form và hiển thị thông báo thành công
